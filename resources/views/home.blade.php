...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        @if(Session::has('RegisterDoneMsg'))
        <div style="text-align: center;">
            <p class="alert {{ Session::get('alert-class', 'alert-success') }}" style="border-radius: 0 !important;">{{ Session::get('RegisterDoneMsg') }}</p><br>
        </div>
        @endif

        @if(Session::has('RegisterDoneMsgStudents'))
        <div style="text-align: center;">
            <p class="alert {{ Session::get('alert-class', 'alert-success') }}" style="border-radius: 0 !important;">{{ Session::get('RegisterDoneMsgStudents') }}</p><br>
        </div>
        @endif
