                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('student/student_login') }}">
                        ...
                        <div class="form-group row">
                            <label for="student_email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Address') }}</label>

                            <div class="col-md-6">
                                <input id="student_email" type="email" class="form-control{{ $errors->has('student_email') ? ' is-invalid' : '' }}" name="student_email" value="{{ old('student_email') }}" required autofocus>
