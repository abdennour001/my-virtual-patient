...
@section('content')
    ...
    <div class="container w-75 p-5">
        <div class="row text-left">
            <div class="col-12">
                <a type="submit" class="btn btn-primary" href="#"><i class="fa fa-angle-left mr-2 font-weight-bolder"></i>Back</a>
            </div>
        </div>
        ...
        <div class="row text-right">
            <div class="col-12">
                <a class="btn btn-primary" href="#">Next<i class="fa fa-angle-right ml-2 font-weight-bold"></i></a>
            </div>
        </div>
    </div>
